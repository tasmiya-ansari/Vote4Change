...
public class UpdateCandidateControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            {
                ArrayList<String> cidList=CandidateDAO.getAllCandidateIds();
                request.setAttribute("cidList",cidList);
                request.setAttribute("result","candidateList");//2 attributes isliye qk adminshowcandiadte.jsp 2 kaam krega ek baar cidList bhejega ek baar details to distinguish krne ke liye ki kb kya bhejna h
            }
            else
            {
